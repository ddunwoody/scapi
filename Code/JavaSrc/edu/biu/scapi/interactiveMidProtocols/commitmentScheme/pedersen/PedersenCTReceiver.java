...
public class PedersenCTReceiver extends PedersenReceiverCore implements CTReceiver, PerfectlyHidingCT, OnBigIntegerCommitmentScheme {
	 ...
	 */
	public PedersenCTReceiver(Channel channel) throws IOException {
		super(channel);
	}
	 ...
	 */
	public PedersenCTReceiver(Channel channel, DlogGroup dlog, SecureRandom random) throws SecurityLevelException, InvalidDlogGroupException, IOException{
