/*
   ...
   Compile as 
   cl /O2 /GX ibe_encx.cpp zzn2.cpp big.cpp zzn.cpp ecn.cpp miracl.lib
...
// ENCRYPT
    ...
    common >> x >> y;
    EBrick B(x,y,(Big)-3,(Big)0,p,8,QBITS);   // precomputation based on fixed P, 8-bit window

#ifdef AFFINE
    ecurve(-3,0,p,MR_AFFINE);
#endif
#ifdef PROJECTIVE
